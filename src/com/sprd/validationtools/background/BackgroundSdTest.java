    ...
    public void startTest() {
        thread = new Thread() {
            public void run() {
                ...
                //If DUT not support SDcard, set result == 0.
                boolean mDisableExternalStorage = ValidationToolsUtils.isDisableExternalStorage();
                Log.d("BackgroundSdTest", "mDisableExternalStorage="+mDisableExternalStorage);
