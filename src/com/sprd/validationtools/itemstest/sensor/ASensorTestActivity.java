...
public class ASensorTestActivity extends BaseActivity {
    private static final String TAG = "ASensorTestActivity";
    ...
    private void showArrow(float x, float y) {
        ...
        if (mUpTxt.getBackground() != null && mDownTxt.getBackground() != null
            ...
            mHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(ASensorTestActivity.this, R.string.text_pass,
