        ...
        mListener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                if (onetime && (data_current[0] != 0) && (data_current[1] != 0)
                    ...
                    Log.d(TAG, "data_last[0] = " + data_last[0] + " ; data_last[1] = "+ data_last[1] + " ; data_last[2] = " + data_last[2]);
                }
                Log.d(TAG, "data_current[0] = " + data_current[0] + " ; data_current[1] = "+ data_current[1] + " ; data_current[2] = " + data_current[2]);
                ...
                Log.d(TAG, "xPass = " + xPass + " ; yPass = "+ yPass + " ; zPass = " + zPass);
                if (xPass && yPass && zPass) {
                    /*SPRD bug 760913:Test can pass/fail must click button*/
                    //if(Const.isBoardISharkL210c10()){
