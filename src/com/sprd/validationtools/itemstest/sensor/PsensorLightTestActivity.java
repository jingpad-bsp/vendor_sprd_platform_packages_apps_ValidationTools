...
public class PsensorLightTestActivity extends BaseActivity {
    ...
    private static final String TAG = "PsensorLightTestActivity";
    private boolean mSupportLsensor = true;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mContext = this;
        setContentView(R.layout.sensor_proximity_light);
        setTitle(R.string.proximity_light_sensor_test);
    ...
    private void initSensor() {
        ...
        pListener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                /*SPRD bug 744593:We check P sensor success only near to far.*/
                Log.d(TAG, "onSensorChanged22 mSensorMax="+mSensorMax+",mSensorMin="+mSensorMin+
