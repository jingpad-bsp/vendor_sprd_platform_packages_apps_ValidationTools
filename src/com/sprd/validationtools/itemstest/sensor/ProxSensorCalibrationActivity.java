...
public class ProxSensorCalibrationActivity extends BaseActivity {
    ...
    private Button mAutoRetestButton;
    private Button mManualRetestButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAutoRetestButton = (Button) findViewById(R.id.auto_retest_btn);
        mManualRetestButton = (Button) findViewById(R.id.manual_retest_btn);
        ...
        mAutoButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                mTestTips.setTextColor(Color.RED);
        ...
        mAutoRetestButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                mTestTips.setTextColor(Color.RED);
                Log.d(TAG, "mAutoRetestButton");
                mAutoRetestButton.setVisibility(View.GONE);
                mFailButton.setEnabled(false);
                mManualRetestButton.setVisibility(View.GONE);
                mTestTips.setText(getResources().getString(R.string.prox_auto_test_tips));
                mProxHandler.sendMessage(mProxHandler.obtainMessage(START_AUTO_TEST));
            }
        });
        mManualRetestButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                mTestTips.setTextColor(Color.RED);
                Log.d(TAG, "mManualRetestButton");
                //mAutoRetestButton.setVisibility(View.GONE);
                mFailButton.setEnabled(false);
                mManualRetestButton.setVisibility(View.GONE);
                showTipsDialog(MANUAL_TEST_NEAR);
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case RESULT_AUTO_TEST:
                    ...
                    Log.d(TAG, "handleMessage RESULT_AUTO_TEST autoResult = " + autoResult );
                    mProxHandler.sendMessage(mProxHandler.obtainMessage(SVAE_AUTO_TEST));
                    break;
                case SVAE_AUTO_TEST:
                    autoSaveResult = saveResult();
                    Log.d(TAG, "handleMessage SVAE_AUTO_TEST autoResult = " + autoResult + " ; autoSaveResult = " + autoSaveResult );
                    if (autoResult && autoSaveResult) {
                        ...
                        mHandler.post(new Runnable() {
                            public void run() {
                                ...
                                //mAutoRetestButton.setVisibility(View.VISIBLE);
                                mManualRetestButton.setVisibility(View.VISIBLE);
                ...
                case RESULT_MANUAL_NEAR_TEST:
                    ...
                    if (nearResult) {
                        mHandler.post(new Runnable() {
                            public void run() {
                                mTestTips.setTextColor(Color.GREEN);
                                mTestTips.setText(getResources().getString(
                                        R.string.prox_manual_tips_near_ok));
                            }
                        });
                    } else {
                        mHandler.post(new Runnable() {
                ...
                case SVAE_MANUAL_NEAR_TEST:
                    ...
                    Log.d(TAG, "handleMessage SVAE_MANUAL_NEAR_TEST nearResult = " + nearResult + " ; nearSaveResult = " + nearSaveResult );
                ...
                case RESULT_MANUAL_FAR_TEST:
                    farResult = getResult();
                    Log.d(TAG, "handleMessage RESULT_MANUAL_FAR_TEST farResult = " + farResult );
                ...
                case SVAE_MANUAL_FAR_TEST:
                    ...
                    if (nearResult && farResult && farSaveResult) {
                        mHandler.post(new Runnable() {
                            public void run() {
                                //mPassButton.setVisibility(View.VISIBLE);
                                Toast.makeText(mContext, R.string.text_pass,
                        ...
                        /*final String str = ((nearResult) ? getResources().getString(
                                ...
                                + "\n"
                                + ((farResult && farSaveResult) ? getResources().getString(
                                        R.string.prox_manual_tips_far_pass) : getResources()
                                        .getString(
                                                R.string.prox_manual_tips_far_fail));*/
                        final String str = (getResources().getString(R.string.prox_manual_tips_near_fail))
                                + "\n"
