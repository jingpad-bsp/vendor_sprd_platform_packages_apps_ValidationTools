...
public class CameraTestActivity extends BaseActivity implements TextureView.SurfaceTextureListener {
    ...
    private boolean mIsFreezeScreen = true;//Const.isBoardISharkL210c10();
    /*@}*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* @} */
        mHandler.sendEmptyMessageDelayed(CAMERA_TIME_OUT, 300000);
        ...
        try {
            ...
            for (String strcameraId : cameraIdList) {
                ...
                Log.d(TAG, " cameraId = " + cameraId + " ; mCameraId = " + mCameraId);
    ...
    private void startCamera() {
        ...
        try {
            Log.e(TAG, "openCamera cameraId = " + mCameraId);
        ...
        if (mCamera != null) {
            ...
            boolean isSupportedFlashTorch = isSupported(Camera.Parameters.FLASH_MODE_TORCH, supportedFlashModes);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width,
        ...
        Log.i(TAG, " hasmainbackcamera = " + hasmainbackcamera);
        if (!hasmainbackcamera) {
            mLightMsg.setText(R.string.mianback_camera_open_failue);
        } else {
            startCamera();
        }
    }
    ...
    protected void onResume() {
        ...
        if(mFlag) {
            mCameraHandler.post(new Runnable() {
                @Override
                public void run() {
                     Log.i(TAG, " onResume hasmainbackcamera = " + hasmainbackcamera);
                     if (!hasmainbackcamera) {
                         mLightMsg.setText(R.string.mianback_camera_open_failue);
                     } else {
                         startCamera();
