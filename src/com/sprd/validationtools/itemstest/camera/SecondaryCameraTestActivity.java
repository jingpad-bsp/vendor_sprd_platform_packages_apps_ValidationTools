...
public class SecondaryCameraTestActivity extends BaseActivity implements
    ...
    private boolean hassecondbackcamera = false;
        ...
        try {
            ...
            for (String strcameraId : cameraIdList) {
                ...
                if (cameraId == Integer.parseInt(mCameraID))
                    hassecondbackcamera = true;
            }
            Log.d(TAG, " onCreate hassecondbackcamera = " + hassecondbackcamera);
            if(!hassecondbackcamera)
            {
                mPassButton.setVisibility(View.GONE);
                mLightMsg.setText(R.string.secondback_camera_open_failue);
            }
            else
            {
                mLightMsg.setVisibility(View.GONE);
    ...
    protected void onResume() {
        ...
        if (mPreviewView.isAvailable()) {
            ...
            Log.i(TAG, " onResume hassecondbackcamera = " + hassecondbackcamera);
            if (!hassecondbackcamera) {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width,
        ...
        Log.i(TAG, " hassecondbackcamera = " + hassecondbackcamera);
        if (!hassecondbackcamera) {
