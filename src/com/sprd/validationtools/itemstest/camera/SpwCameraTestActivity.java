...
public class SpwCameraTestActivity extends BaseActivity implements
    ...
    private boolean hasspwcamera = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Log.d(TAG, " onCreate hasspwcamera = " + hasspwcamera);
            if(!hasspwcamera)
            {
                mPassButton.setVisibility(View.GONE);
                mLightMsg.setText(R.string.spw_camera_open_failue);
            }
            else
            {
                mLightMsg.setVisibility(View.GONE);
    ...
    protected void onResume() {
        ...
        if (mPreviewView.isAvailable()) {
            ...
            Log.i(TAG, " onResume hasspwcamera = " + hasspwcamera);
            if (!hasspwcamera) {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width,
        ...
        Log.i(TAG, " hasspwcamera = " + hasspwcamera);
        if (!hasspwcamera) {
