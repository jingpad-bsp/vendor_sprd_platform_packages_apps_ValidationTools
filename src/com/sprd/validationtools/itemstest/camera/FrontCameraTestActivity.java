...
public class FrontCameraTestActivity extends BaseActivity implements TextureView.SurfaceTextureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            for (String strcameraId : cameraIdList) {
                ...
                Log.d(TAG, " cameraId = " + cameraId + " ; FRONT_CAMERA = " + FRONT_CAMERA);
                if (cameraId == 0)
            ...
            {
                Log.i(TAG, " has no main back camera ");
                FRONT_CAMERA = 0;
            }
    ...
    private void startCamera() {
        ...
        try {
            Log.e(TAG, "openCamera cameraId = " + FRONT_CAMERA);
...
//            parameters.setFlashMode(Camera.Parameters.FLASH_MODE_TORCH);
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width,
        ...
        Log.i(TAG, " hasfrontcamera = " + hasfrontcamera);
        if (!hasfrontcamera) {
            mLightMsg.setText(R.string.front_camera_open_failue);
        } else {
            startCamera();
        }
    }
